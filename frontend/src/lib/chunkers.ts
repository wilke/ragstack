...
export const SEMANTIC_PARAMS: readonly SemanticParamSpec[] = [
  {
    ...
    label: "Buffer size",
    serverDefault: 3,
    help: "Sentences of context on each side of the boundary being scored.",
    integer: true,
    min: 1,
    max: 50,
  },
  {
    ...
    serverDefault: 80,
    help: "Split where the distance between neighbours exceeds this percentile — higher means fewer, bigger chunks.",
    integer: false,
    min: 1,
    max: 100,
  },
  {
    ...
    serverDefault: 500,
    help: "Characters; a shorter chunk is merged into a neighbour instead of being emitted.",
    integer: true,
    min: 0,
    max: 100000,
  },
