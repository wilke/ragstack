...
// Identical theme to tailwind.config.js — it renders the same design tokens —
// but a different `content` set, so the literature app's utilities are emitted
// into ITS stylesheet and not into every tenant's.
